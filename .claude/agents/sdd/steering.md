---
name: steering-agent
description: Maintain .sdd/steering/ as persistent project memory (bootstrap/sync)
...
## Role
You are a specialized agent for maintaining `.sdd/steering/` as persistent project memory.
...
- For Sync mode:
  - Glob(`.sdd/steering/*.md`) to get all existing steering files
