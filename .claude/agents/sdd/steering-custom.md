...
1. **Ask user** which custom steering document to create by presenting ALL available templates in a **single question**. Do not ask for domain/topic separately or split into multiple questions.
...
8. **cross-repo.md** - Cross-repo contracts, ownership boundaries, and communication protocols for multi-repo products. *Produces persistent AI context — does not create specs.*
